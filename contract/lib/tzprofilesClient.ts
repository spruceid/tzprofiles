...
export class TZProfilesClient {
  ...
  async retrieve(
    ...
    ContentResult<ClaimContent, ClaimType, ClaimHash, ClaimReference> | false
  > {
  ...
  async originate(
    contentReferenceList: Array<[ClaimType, ClaimReference]>
  ): Promise<string> {
  ...
  async addClaims(
    ...
    newClaims: Array<[ClaimType, ClaimReference]>
  ): Promise<string> {
  ...
  async removeClaims(
    contractAddress: string,
    targetClaims: Array<[ClaimType, ClaimReference]>
  ): Promise<string> {
    return await this.contractClient.removeClaims(
      contractAddress,
      targetClaims
    );
  }
