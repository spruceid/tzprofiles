...
class ContractClient {
  ...
  bcdPrefix() {
    return `${this.bcd.base}${this.trailingSlash(this.bcd.base)}v${
      this.bcd.version
    }/`;
  }
      ...
      for (var claim in claims) {
        contents.push({
          children: [
            ...
            { value: claims[claim]['1'] },
            { value: claims[claim]['2'] },
          ],
        });
      }
      return contents;
  ...
  retrieve(walletAddress) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let searchRes = yield axios_1.default.get(
        `${prefix}search?q=${walletAddress}&n=${this.bcd.network}&i=contract&f=manager`
      );
  ...
  originate(contentReferenceList) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to originate'
        );
      }
      if (!this.signerSet) {
        yield this.setSigner();
  ...
  addClaims(contractAddress, contentReferenceList) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to addClaims'
        );
      }
      if (!this.signerSet) {
        yield this.setSigner();
