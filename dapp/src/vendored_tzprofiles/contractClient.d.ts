...
export declare type BetterCallDevNetworks =
  | 'mainnet'
  | 'delphinet'
  | 'edonet'
  | 'florencenet'
...
export declare type ContentTriple<ContentType, Hash, Reference> = [
  Reference,
  Hash,
  ContentType
];
export declare type ContentList<ContentType, Hash, Reference> = Array<
  ContentTriple<ContentType, Hash, Reference>
>;
export declare type InvalidContent<ContentType, Hash, Reference> = [
  Reference,
  Hash,
  ContentType,
  any,
...
export declare type ValidContent<Content, ContentType, Reference> = [
  Reference,
  Content,
  ContentType
];
...
export declare class ContractClient<Content, ContentType, Hash, Reference> {
  ...
  ): Promise<ContentResult<Content, ContentType, Hash, Reference> | false>;
  originate(
    contentReferenceList: Array<[ContentType, Reference]>
  ): Promise<string>;
  addClaims(
