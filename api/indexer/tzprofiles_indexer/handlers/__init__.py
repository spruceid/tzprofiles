...
async def retrieve_claim(kepler_link: str) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    asyncio.run(
        resolve_profile(
            [
                TestItem(
                    "kepler://zCT5htke6yr5beimA2E3cXAmtp7LLRiC1ngnXmWHnuWoTcbZXUHg/zb38S6xPKFexetMmZ4NQ4whx5FUWvxNKbZNbtcnm85JoL5smz",
                    "f58c32db1c9707c1e6af351add6fad7a8797448d264ec0b03c8294c6b754aabe",
                ),
                TestItem(
                    "kepler://zCT5htke6yr5beimA2E3cXAmtp7LLRiC1ngnXmWHnuWoTcbZXUHg/zb38S7bFhMPrRZsRb8dxpcdbyDTRmivvg4KXv2d3RmqJiVs3X",
                    "85274f9d21ef8ef00b51a1c5b2b41390f30ee6f860d035062b912de2d9443fcf",
                ),
                TestItem(
                    "kepler://zCT5htke6yr5beimA2E3cXAmtp7LLRiC1ngnXmWHnuWoTcbZXUHg/zb38SFSPd8om2Qt5B8rdyqwgTJphgpsw6ezW9jp223q1MFXAP",
                    "03b4479cf248f4d56fbc99f36d472a5e51c2ab547b98e7745740d0e8f9e9d9fd",
                ),
            ],
            profile,
        )
